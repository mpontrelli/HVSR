...
statname = 'M65A';
starttime = '2019-06-17 06:07:00';
endtime = '2019-06-17 07:07:00';

[sampletimes,trace1,waveformfilt] = getDMCData(starttime,endtime ,statname,'*','BHZ');
...
[~,trace1,waveformfilt] = getDMCData(starttime,endtime ,statname,'*','BHE');
EW = trace1.data;
%EW = EW(1:length(EW)-1);

[~,trace1,waveformfilt] = getDMCData(starttime,endtime ,statname,'*','BHN');
NS = trace1.data;
%NS = NS(1:length(NS)-1);
