...
% ref = 'FJ74';
sheet = 1;
outpath = strcat('C:\Users\mpontr01\Box\Pontrelli_et_al_2020\HVSRs_all_events\');
...
for ii = 1:length(sitelist)
    ...
    %if strcmp(statname,ref) ==0 %&& strcmp(statname,'CC55') ==0
        rownum = num2str(ii + 1);
        load(strcat('C:\Users\mpontr01\Box\Data\Ground motion\Mexico CIty\geomean_HVSR\',...
        statname))
...
% 
%     
        writematrix(datamat,filename,'Sheet',sheet,'Range',strcat('D',rownum,':I',rownum))
        clear xlim
        clear ylim
        close all
    end
