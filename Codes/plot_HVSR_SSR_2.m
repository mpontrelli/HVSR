...
%'AE02','AL01','AO24', 'AP68','AR14','AU11','AU46','BA49','BL45','BO39',...
    ...
    %'GC38','GR27','HA41','HJ72', 'IB22','PD42','PE10', 'RI76', 'RM48',...
    %'SI53', 'SP51','TH35', 'TL08', 'TL55',
...
outpath = 'C:\Users\mpontr01\Box\Pontrelli_et_al_2020\HVSR_SSR_comparison\';
for i = 1:length(sitelist)
    
statname = sitelist{i};

% Load SSR
load(strcat('C:\Users\mpontr01\Box\Data\Ground motion\Mexico CIty\geomean_SSR\', statname))

ahatfSSR = data.ahatf';
sigmaSSR = data.sigma';
confinthighSSR = data.confinthigh';
confintlowSSR  = data.confintlow';

% load HVSR
load(strcat('C:\Users\mpontr01\Box\Data\Ground motion\Mexico CIty\geomean_HVSR\', statname));
ahatfHV = data.ahatf';
sigmaHV = data.sigma';
confinthighHV = data.confinthigh';
confintlowHV  = data.confintlow';
